...
import org.springframework.ldap.samples.utils.NodoLDAPTreeVisitor;
...
public class RestController
{
	...
	public @ResponseBody String getExpedientesByAplicacion()
	{
...
//		HtmlRowLdapTreeVisitor visitor = new PersonLinkHtmlRowLdapTreeVisitor();
		NodoLDAPTreeVisitor visitor = new NodoLDAPTreeVisitor(new Long(2));
		...
		NodeRoot nodeRoot = visitor.getNodeRoot();
...
//		    	
//		    	nodeRoot = new NodeRoot(new Long(2), "Nosotros", nodeChildren);
		//    	
		//    	"id" : 1,
		//    	"title" : "Nosotros",
		//    	"root" : {
	 ...
	 * sobreescribiendo la forma en la que generamos los urls de acceso a la informacion de un nodo.
